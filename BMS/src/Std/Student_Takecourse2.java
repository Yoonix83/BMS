...
public class Student_Takecourse2 extends JPanel implements ActionListener{
	...
	Student_Takecourse2(String stdNum_lg) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == add){ // -- [ 추가 ] button 
			...
			if(!course_box.getSelectedItem().toString().equals(arr[0])) {
				...
				//동일한 과목 비교 코드
				try {
					for(int i = 0 ; i <= i+1 ; i = i+3) {
						
						System.out.println(table.getRowCount()+ " : " +list.get(i) + " : " + arr[0]);
						
						if(list.get(i).equals(arr[0])) {
							
							JOptionPane.showMessageDialog(null, "동일한 과목을 선택하셨습니다!2");
						}
					}
